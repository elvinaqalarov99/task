...
class CompanyTest extends TestCase
{
    ...
    public function test_the_companies_index_page_is_rendered_correctly()
    {
        ...
        // we want to hist dashboard/companies page
        $response = $this->get('dashboard/companies');

        $response->assertStatus(200);
    }

    public function test_users_can_create_companies(){
